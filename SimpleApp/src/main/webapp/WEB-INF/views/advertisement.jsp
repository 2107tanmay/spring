...
<tr>
    ...
    <td><form:input path="advertisementId" name="advertisementId"/></td>
</tr>

<tr>
    <td>Advertisement Type</td>
    <td><form:input path="advertisementType" name="advertisementType"/></td>
</tr>

<tr>
    <td>Cost</td>
    <td><form:input path="cost" name="cost"/></td>
</tr>
