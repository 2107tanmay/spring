...
public class RegistrationController {
	...
	public String registerPage(@ModelAttribute("register")
...
//			result.getModel().put(
//	                "message",
//	                "Thank you " + registrationBean.getUserName() +
//	                ".We shall mail the contents to " + registrationBean.getConfirmEmailId()
//	        );
